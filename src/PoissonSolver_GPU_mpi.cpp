...
void vvm::PoissonSolver::InitAMGX(vvm &model) {
    ...
    std::string config_w = "{\"config_version\": 2, \"solver\": {\"preconditioner\": {\"scope\": \"ilu\", \"solver\": \"ILU0\"}, \"scope\": \"main\", \"solver\": \"BICGSTAB\", \"tolerance\": 1e-15, \"max_iters\": 10000, \"monitor_residual\": 1, \"print_solve_stats\": 0}}";
